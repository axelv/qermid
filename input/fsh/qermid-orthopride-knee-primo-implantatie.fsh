Logical: orthopridekneeprimoimplantatie
Id: orthopride-knee-primo-implantatie
Title: "Orthopride Knee - Fields_Primo-implantatie"
Description: "QERMID Orthopride Knee - Fields_Primo-implantatie data collection"
...
* CD_DIAGS from disorder_141_VS (required)
...
* CD_DRCT_ALIGN 1..1 string "Alignement"
* TX_DRCT_ALIGN_RMRK 0..1 string "Opmerkingen"
...
* CD_IMPLANT from implants_129_VS (required)
...
* CD_PTR 1..1 code "Patellaire interface?"
* CD_PTR from yn_VS (required)
