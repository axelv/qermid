Logical: orthopridehipprimoimplantatie
Id: orthopride-hip-primo-implantatie
Title: "Orthopride Hip - Fields_Primo-implantatie"
Description: "QERMID Orthopride Hip - Fields_Primo-implantatie data collection"
...
* CD_DIAGS from disorder_75_VS (required)
...
* D_DIAGS_START 0..1 string "Probleem begindatum"
* D_DIAGS_STP 0..1 string "Probleem einddatum"
* CD_ASA_CLASS 1..1 code "ASA classificatie"
* CD_ASA_CLASS from asa_classification_VS (required)
* MS_PAT_WGHT 1..1 string "Gewicht (kg)"
* D_PAT_WGHT 0..1 string "Date gewicht"
* MS_PAT_HGHT 1..1 string "Lengte (cm)"
* D_PAT_HGHT 0..1 string "Date lengte"
* CD_COMORB 0..* string "comorbiditeit"
...
* D_COMORB_START 0..1 date "Probleem begindatum"
* D_COMORB_STP 0..1 date "Probleem einddatum"
...
* CD_USE_NAV 0..* string "Gebruik van navigatie computer"
* CD_USE_AR 0..* string "Gebruik van Augmented Reality (AR)"
...
* CD_IMPLANT_HIP 1..1 code "Soort implantaat"
...
* CD_IMPLANT_HIP_RSCT 1..1 code "Resectie prothese"
* CD_IMPLANT_HIP_RSCT from yn_VS (required)
* CD_IMPLANT_HIP_RSCT_TPE 1..1 code "type resectie prothese"
* CD_IMPLANT_HIP_RSCT_TPE from implants_87_VS (required)
...
* CD_IMPLANT 1..1 code "Type"
* CD_IMPLANT from implants_90_VS (required)
